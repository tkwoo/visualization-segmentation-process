...
parser.add_argument("--image_size", help="image size", default=256, type=int)
parser.add_argument("--batch_size", help="batch size", default=1, type=int)
parser.add_argument("--total_epoch", help="number of epochs", default=1000, type=int)
...
parser.add_argument("--epoch_per_decay", help="lr decay period", default=1000, type=int)
